...
export const DEFAULT_THEMES: ThemeItem[] = [
  ...
  },
  {
    ...
    date: '2026年3月',
    rawText: '大家好。今天，我想谈谈我最好的朋友。好朋友是理解我们、支持我们，并在好坏时光都陪伴着我们的人。每当我有话要说时，我最好的朋友总是会倾听我的心声。我们喜欢聊天、欢笑并共度时光。当我们要面对困难时，我们也会互相帮助。

真正的朋友不需要是完美的。真正的朋友是诚实、体贴且值得信赖的人。我们有时可能会有分歧，但我们尊重彼此，并原谅对方的错误。我很感激能有一位让我的生活变得更快乐的朋友。良好的友谊是值得我们永远珍惜的美好礼物。谢谢大家的聆听。',
    gradeStamp: '名',
},
];
